...
public class MainActivity extends AppCompatActivity implements
        ConnectionCallbacks, OnConnectionFailedListener, ResultCallback<Status>, View.OnClickListener {
    private static final String TAG = "MainActivity";
    public static final String SHARED_PREFERENCES_NAME = BuildConfig.APPLICATION_ID + ".SHARED_PREFERENCES_NAME";
    public static final String GEOFENCES_ADDED_KEY = BuildConfig.APPLICATION_ID + ".GEOFENCES_ADDED_KEY";
    ...
    public void onResult(Status status) {
        if (status.isSuccess()) {
            ...
            String errorMessage = GeofenceTransitionsIntentService.getErrorString(this,
    ...
    public void onClick(View v) {
        if(v.getId() == mAddGeofencesButton.getId()){
            addGeofencesButtonHandler();
        }else if(v.getId() == mRemoveGeofencesButton.getId()){
